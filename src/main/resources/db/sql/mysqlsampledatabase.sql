...
*********************************************************************
Name: MySQL Sample Database order_system
...
insert into `offices`(`office_code`, `city`, `phone`, `address_line1`, `address_line2`, `state`, `country`,
...
insert into `employees`(`employee_number`, `last_name`, `first_name`, `extension`, `email`, `office_code`, `reports_to`,
                        `job_title`)
...
insert into `orders`(`order_number`, `order_date`, `required_date`, `shipped_date`, `status`, `comments`,
                     `customer_number`)
...
(
    ...
    CONSTRAINT `order_details_ibfk_1` FOREIGN KEY (`order_number`) REFERENCES `orders` (`order_number`),
    CONSTRAINT `order_details_ibfk_2` FOREIGN KEY (`product_code`) REFERENCES `products` (`product_code`)
) ENGINE = InnoDB
  DEFAULT CHARSET = latin1;
